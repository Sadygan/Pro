...
class SpecificationsControllerTest < ActionController::TestCase
  ...
  test "should create specification" do
    assert_difference('Specification.count') do
      post :create, specification: { name: @specification.name, project_id: @specification.project_id, style: @specification.style }
    end
  ...
  test "should update specification" do
    patch :update, id: @specification, specification: { name: @specification.name, project_id: @specification.project_id, style: @specification.style }
    assert_redirected_to specification_path(assigns(:specification))
  end
